...
-- Khóa ngoại giữa ORDER_OFFLINE và BRANCH
ALTER TABLE ORDER_OFFLINE
ADD CONSTRAINT FK_OrderOffline_Branch FOREIGN KEY (BranchID) REFERENCES BRANCH(BranchID);
GO
